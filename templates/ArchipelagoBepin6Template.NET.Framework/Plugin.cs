...
using ArchipelagoBepin6Template.NET.Framework.Archipelago;
using ArchipelagoBepin6Template.NET.Framework.Utils;
using BepInEx.NET.Common;
using UnityEngine;

namespace ArchipelagoBepin6Template.NET.Framework;

[BepInPlugin(PluginGUID, PluginName, PluginVersion)]
public class Plugin : BasePlugin
{
    public const string PluginGUID = "com.yourName.projectName";
    public const string PluginName = "ArchipelagoBepin6Template.NET.Framework";
