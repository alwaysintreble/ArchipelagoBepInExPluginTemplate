...
using ArchipelagoBepin6Template.Net.CoreCLR.Archipelago;
using ArchipelagoBepin6Template.Net.CoreCLR.Utils;
using BepInEx.NET.Common;
using UnityEngine;

namespace ArchipelagoBepin6Template.Net.CoreCLR;

[BepInPlugin(PluginGUID, PluginName, PluginVersion)]
public class Plugin : BasePlugin
{
    public const string PluginGUID = "com.yourName.projectName";
    public const string PluginName = "ArchipelagoBepin6Template.Net.CoreCLR";
