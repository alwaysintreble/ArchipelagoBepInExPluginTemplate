...
using ArchipelagoBepin6Template.Unity.Mono.Archipelago;
using ArchipelagoBepin6Template.Unity.Mono.Utils;
using BepInEx.Unity.Mono;
using UnityEngine;

namespace ArchipelagoBepin6Template.Unity.Mono;

[BepInPlugin(PluginGUID, PluginName, PluginVersion)]
public class Plugin : BaseUnityPlugin
{
    public const string PluginGUID = "com.yourName.projectName";
    public const string PluginName = "ArchipelagoBepin6Template.Unity.Mono";
